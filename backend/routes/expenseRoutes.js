...
const express = require('express');
const { getAllExpenses, getExpenseById, createExpense, updateExpense, deleteExpense,getAllExpensesForAdmin } = require('../controllers/expenseController');
const authMiddleware = require('../middleware/authMiddleware');
...
router.get('/admin/expenses', [authMiddleware, checkAdmin], getAllExpensesForAdmin);

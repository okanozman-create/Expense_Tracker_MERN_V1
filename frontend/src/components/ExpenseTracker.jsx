    ...
    const fetchExpenses = async () => {
      ...
      try {
        const response = await axios.get("http://localhost:5000/api/expenses", {
          // const response = await axios.get("https://backend-nr2q.onrender.com/api/expenses", {
          headers: {
            "x-auth-token": token,
          },
        });
  ...
  const addExpense = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        // "https://backend-nr2q.onrender.com/api/expenses",
        newExpense,
        {
          headers: {
            "x-auth-token": token,
    ...
    <section className="section flex flex-col items-s">
      <div className="px-2">
        ...
        <h2
          ...
          } text-3xl mb-7 text-left lg:text-center lg:text-5xl pl-2 underline decoration-slate-500`}
        >
          Expense List
        </h2>
